...
int64 nChainStartTime = 1393869414;
...
const string strMessageMagic = "Bppumpscoin Signed Message:\n";
...
// bppumpscoin: increasing Nfactor gradually
...
{      if(nHeight<=1){
      return (3588000+888)*COIN;
     }
    else if(nHeight==2)
    {return (411000+111)*COIN;
    }
    else  if(nHeight>2&&nHeight<=20000){
        return 5*COIN;
    ...
    else if (nHeight>800000&&nHeight<=1800000)
    {
        return  1*COIN;

    }
    else if (nHeight>1800001&&nHeight<=5800000)
    {
        return 0.5*COIN;

    }

    else if(nHeight>5800000){
        return 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Bppumpscoin
    bool fStrictPayToScriptHash = true; // Always active in Bppumpscoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bppumpscoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime = nChainStartTime + 120;
        ...
        assert(block.hashMerkleRoot == uint256("0x89aeffe01fc73bc4d70e78211603938e6b336c9963924d3684e030a3975836ca"));
        block.print();
