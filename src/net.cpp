...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bppumpscoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"bppumpscoin.ie1.cn", "seeds.bppumpscoin.ie1.cn"},
    {"bppumpscoin.ie1.cn", "seed1.bppumpscoin.ie1.cn"},
    {"bppumpscoin.ie1.cn", "seed2.bppumpscoin.ie1.cn"},
    {"bppumpscoin.ie1.cn", "tnseeds.bppumpscoin.ie1.cn"}
};
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("bppumpscoin-opencon");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bppumpscoin is probably already running."), addrBind.ToString().c_str());
        else
