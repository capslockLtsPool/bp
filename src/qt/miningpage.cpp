...
void MiningPage::minerError(QProcess::ProcessError error)
{
    ...
    {
        reportToList(tr("Miner failed to start. Make sure you have the minerd executable and libraries in the same directory as Bppumpscoin-Qt."), ERROR, NULL);
    }
}
...
{
    if (index == 0){  // pool.bppumpscoin.org
